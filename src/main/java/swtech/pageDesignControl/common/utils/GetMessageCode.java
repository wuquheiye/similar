...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "120639";
    private static final String AUTH_TOKEN = "63dfb1c1730ef5c4c85328b015a89e13";
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【xxxx】您的验证码为：" + rod + "，请于"+1+"分钟内正确输入，如非本人操作，请忽略此短信。";
    ...
    public static void main(String[] args) {
        String result = getCode("15890011921");
    }
